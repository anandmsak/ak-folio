...
export default function Achievements() {
  const competitiveRecords = achievements.filter((item) => item.type !== "research");
  ...
  return (
    <section id="achievements" className="py-28 max-w-[1400px] mx-auto px-6 md:px-16 lg:px-24 relative z-10">
      <SectionTitle
        ...
        subtitle="Verified competitive records, hackathon tracks, and hardware expo victories mapped on a circuit timeline."
      />
      ...
      <div className="max-w-4xl mx-auto relative pl-10 md:pl-0">
        ...
        <div className="space-y-12">
          {competitiveRecords.map((record, i) => {
            const isEven = i % 2 === 0;
            ...
            return (
              <div key={record.title} className={`relative flex flex-col md:flex-row items-start ${isEven ? "md:flex-row-reverse" : ""}`}>
                ...
                <div className="w-full md:w-1/2 md:px-8">
                  <Reveal direction={isEven ? "left" : "right"}>
                    <div className="border border-white/5 bg-gradient-to-b from-white/[0.03] to-transparent p-5 rounded-xl transition-all duration-300 relative group">
                      ...
                      {/* Top Diagnostic Ribbon — CRITICAL FIX: Enhanced Year Identifier Visibility */}
                      <div className="flex items-center justify-between gap-4 mb-3 font-mono">
                        ...
                        {/* High-Contrast Clear Read Neon Badge */}
                      ...
                      <h4 className="text-base font-bold text-slate-100 tracking-tight mb-1.5 font-sans group-hover:text-white transition-colors">
                        {record.title}
                      </h4>
                      ...
                      <div className="inline-flex items-center gap-1.5 font-mono text-[9px] text-gray-500 bg-black/40 border border-white/5 rounded px-2.5 py-1 uppercase">
                ...
                {/* Desktop Balance Spacer Grid Column */}
